...
async function retryAttemptCountBackoff(fn, strategy, config2) {
  let attempt = 0;
  while (true) {
    try {
...
function agentsCreate(client2, body, api_version, options) {
  return new APIPromise($do$q(client2, body, api_version, options));
}
async function $do$q(client2, body, api_version, options) {
  var _a2, _b, _c;
  const input = {
    body,
    api_version
  ...
  const pathParams = {
    api_version: encodeSimple("api_version", (_a2 = payload.api_version) !== null && _a2 !== void 0 ? _a2 : client2._options.api_version, { explode: false, charEncoding: "percent" })
  };
...
function agentsDelete(client2, id, api_version, options) {
  return new APIPromise($do$p(client2, id, api_version, options));
}
...
function agentsGet(client2, id, api_version, options) {
  return new APIPromise($do$o(client2, id, api_version, options));
}
...
function agentsList(client2, api_version, page_size, page_token, parent, options) {
  return new APIPromise($do$n(client2, api_version, page_size, page_token, parent, options));
}
async function $do$n(client2, api_version, page_size, page_token, parent, options) {
  ...
  const body = null;
  const pathParams = {
    api_version: encodeSimple("api_version", (_a2 = payload === null || payload === void 0 ? void 0 : payload.api_version) !== null && _a2 !== void 0 ? _a2 : client2._options.api_version, { explode: false, charEncoding: "percent" })
  };
  const path = pathToFunc("/{api_version}/agents")(pathParams);
...
function environmentsCreateEnvironment(client2, body, api_version, options) {
  return new APIPromise($do$m(client2, body, api_version, options));
}
async function $do$m(client2, body, api_version, options) {
  var _a2, _b, _c;
  const input = {
    body,
    api_version
...
function environmentsDeleteEnvironment(client2, id, api_version, options) {
  return new APIPromise($do$l(client2, id, api_version, options));
}
...
function environmentsGetEnvironment(client2, id, api_version, options) {
  return new APIPromise($do$k(client2, id, api_version, options));
}
...
function environmentsListEnvironments(client2, api_version, page_size, page_token, options) {
  return new APIPromise($do$j(client2, api_version, page_size, page_token, options));
}
...
function environmentsFilesList(client2, environment, path, api_version, page_size, page_token, recursive, options) {
  return new APIPromise($do$i(client2, environment, path, api_version, page_size, page_token, recursive, options));
}
async function $do$i(client2, environment, path, api_version, page_size, page_token, recursive, options) {
  var _a2, _b, _c;
  const input = {
    environment,
    path,
...
function interactionsCancel(client2, id, api_version, options) {
  return new APIPromise($do$h(client2, id, api_version, options));
}
...
function interactionsCreate(client2, body, api_version, options) {
  return new APIPromise($do$g(client2, body, api_version, options));
}
async function $do$g(client2, body, api_version, options) {
  var _a2, _b, _c, _d;
  const input = {
    body,
    api_version
  ...
  const context = {
    options: client2._options,
    base_url: (_d = (_c = options === null || options === void 0 ? void 0 : options.server_url) !== null && _c !== void 0 ? _c : client2._baseURL) !== null && _d !== void 0 ? _d : "",
...
function interactionsDelete(client2, id, api_version, options) {
  return new APIPromise($do$f(client2, id, api_version, options));
}
...
function interactionsGet(client2, id, api_version, include_input, last_event_id, stream, options) {
  return new APIPromise($do$e(client2, id, api_version, include_input, last_event_id, stream, options));
}
...
function triggersCreate(client2, body, api_version, options) {
  return new APIPromise($do$d(client2, body, api_version, options));
}
async function $do$d(client2, body, api_version, options) {
  var _a2, _b, _c;
  const input = {
    body,
    api_version
...
function triggersDelete(client2, id, api_version, options) {
  return new APIPromise($do$c(client2, id, api_version, options));
}
...
function triggersGet(client2, id, api_version, options) {
  return new APIPromise($do$b(client2, id, api_version, options));
}
...
function triggersListExecutions(client2, trigger_id, api_version, page_size, page_token, options) {
  return new APIPromise($do$a(client2, trigger_id, api_version, page_size, page_token, options));
}
...
function triggersList(client2, api_version, filter, page_size, page_token, options) {
  return new APIPromise($do$9(client2, api_version, filter, page_size, page_token, options));
}
...
function triggersRun(client2, trigger_id, api_version, options) {
  return new APIPromise($do$8(client2, trigger_id, api_version, options));
}
...
function triggersUpdate(client2, id, body, api_version, options) {
  return new APIPromise($do$7(client2, id, body, api_version, options));
}
async function $do$7(client2, id, body, api_version, options) {
  var _a2, _b, _c;
  const input = {
    id,
    body,
...
function webhooksCreate(client2, body, api_version, options) {
  return new APIPromise($do$6(client2, body, api_version, options));
}
async function $do$6(client2, body, api_version, options) {
  var _a2, _b, _c;
  const input = {
    body,
    api_version
...
function webhooksDelete(client2, id, api_version, options) {
  return new APIPromise($do$5(client2, id, api_version, options));
}
async function $do$5(client2, id, api_version, options) {
  var _a2, _b, _c;
  const input = {
    id,
    api_version
...
function webhooksGet(client2, id, api_version, options) {
  return new APIPromise($do$4(client2, id, api_version, options));
}
async function $do$4(client2, id, api_version, options) {
  var _a2, _b, _c;
  const input = {
    id,
    api_version
...
function webhooksList(client2, api_version, page_size, page_token, options) {
  return new APIPromise($do$3(client2, api_version, page_size, page_token, options));
}
async function $do$3(client2, api_version, page_size, page_token, options) {
  var _a2, _b, _c;
  const input = {
    api_version,
    page_size,
...
function webhooksPing(client2, id, api_version, body, options) {
  return new APIPromise($do$2(client2, id, api_version, body, options));
}
async function $do$2(client2, id, api_version, body, options) {
  var _a2, _b, _c;
  const input = {
    id,
    api_version,
...
function webhooksRotateSigningSecret(client2, id, api_version, body, options) {
  return new APIPromise($do$1(client2, id, api_version, body, options));
}
async function $do$1(client2, id, api_version, body, options) {
  var _a2, _b, _c;
  const input = {
    id,
    api_version,
...
function webhooksUpdate(client2, id, api_version, update_mask, body, options) {
  return new APIPromise($do(client2, id, api_version, update_mask, body, options));
}
async function $do(client2, id, api_version, update_mask, body, options) {
  var _a2, _b, _c;
  const input = {
    id,
    api_version,
...
function getClient() {
  ...
  client ??= new GoogleGenAI2({ apiKey: process.env.GEMINI_API_KEY });
  return client;
}
...
var twoSumVideo = (misconceptionId) => ({
  misconceptionId,
